...
#define HEARTBEAT_RX_EVENT      0
#define SDO_RX_EVENT            1
#define PDO_RX_EVENT            2
#define EMERGENCY_RX_EVENT      3
#define RX_EVENT_NOT_ACCEPTED   9
...
// Added by: Staffan
// Says below, 0 is never used but does it cause a problem if I use it?
// Just putting mCANIsPutReady(0); worked before int NMTMaster_Transmit.
// 
#define COMM_NETCTL_NMT_PRODUCER 0              // NMT Producer
						// 0 is never used
...
extern unsigned char _master_heartbeat_receive_en;
#define COMM_HEARTBEAT_RECEIVE_MASTER_EN _master_heartbeat_receive_en

// Added by: Staffan
#define COMM_SDO_MASTER                 0
...
// Added by: Staffan
#define COMM_NETCTL_NMT_PRODUCER_EN     //_net_en.bits.b5
...
// Added by: Staffan
#define COMM_NETCTL_NMT_MASTER_TF       _tx_net_que.bits.b5             // NMT master
...
//Added by: Staffan
//#define COMM_SDO_MASTER_TF              _tx_sdo_que.bits.b4             // SDO master
extern unsigned char COMM_SDO_MASTER_TF;
...
//#define COBID_TO_NODEID(cobid) ((unsigned char) (cobid & 0xFF))
